  ...
  const comments = [
    {
      ...
      date: '2025-01-16',
      content: 'This is exactly what we need in rural communities! Can\'t wait to see this in action.',
      likes: 12,
      replies: 2,
    },
    {
      ...
      date: '2025-01-15',
      content: 'The AI optimization feature sounds incredible. How does it adapt to different water sources?',
      likes: 8,
      replies: 1,
    },
    {
      ...
      date: '2025-01-14',
      content: 'Backed this project immediately. The potential impact on global water access is huge!',
      likes: 15,
      replies: 0,
    },
  ];
